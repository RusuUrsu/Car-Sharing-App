...
void AutoUI::addAuto() {
    ...
    try {
        ...
        autoController.addAuto(newAuto);
...
void AutoUI::removeAuto() {
    ...
    std::cin >> licensePlate;
    autoController.removeAuto(licensePlate);
...
void AutoUI::modifyAuto() {
    ...
    try {
        Auto newAuto(licensePlate, model, brand, yearOfFirstRegistration,
                   mileage, dailyRate, fuelType, transmission, color, remarks, isActive);
        autoController.modifyAuto(newAuto);
...
void AutoUI::listCarsByPrice() {
    autoController.listCarsByPrice();
}
...
void AutoUI::getCarByLicensePlate() {
    ...
    std::cin >> licensePlate;
    autoController.getCarByLicensePlate(licensePlate);
}
...
void AutoUI::filterByBrand() {
    ...
    std::cin >> brand;
    autoController.filterByBrand(brand);
}
...
void AutoUI::filterByModel() {
    ...
    std::cin >> model;
    autoController.filterByModel(model);
}
...
void AutoUI::filterByFuelType() {
    ...
    std::cin >> fuelType;
    autoController.filterByFuelType(fuelType);
}
...
void AutoUI::filterByTransmission() {
    ...
    std::cin >> transmission;
    autoController.filterByTransmission(transmission);
}
...
void AutoUI::filterByPriceRange() {
    ...
    std::cin >> priceRange;
    autoController.filterByPriceRange(priceRange);
}
